...
import {
  loadrecipe,
  PO_DATA,
} from 'src/app/views/operations/Shared/shared-model';
...
@Component({
  ...
  styleUrls: ['./recipe-setup.component.scss'],
})
export class RecipeSetupComponent implements OnInit {
  ...
  recipe: any = [
    {
      nodeId:
        'OMRON_FINS.Masking_MC_28.product_recipe_set_parameters.OTP_PROD_RCP_Setup_Pressure_Kgf_cm3',
      value: 100,
      reference_value: 100,
      datatype: 'dword',
      min_value: 75,
      max_value: 150,
      display_name: 'Setup Pressure Kgf cm3',
      category: 'main',
  ...
  ngOnInit(): void {
    this.appStorage.set('TEM_LAST_URL', 'recipe-setup');
