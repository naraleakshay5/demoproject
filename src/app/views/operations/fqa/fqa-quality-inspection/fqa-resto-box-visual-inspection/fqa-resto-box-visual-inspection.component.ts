...
@Component({
  selector: 'app-fqa-resto-box-visual-inspection',
  templateUrl: './fqa-resto-box-visual-inspection.component.html',
  styleUrls: ['./fqa-resto-box-visual-inspection.component.scss'],
})
export class FqaRestoBoxVisualInspectionComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
  ...
  proceed() {
    this.fqaService.testComplete('Visual Inspection');
