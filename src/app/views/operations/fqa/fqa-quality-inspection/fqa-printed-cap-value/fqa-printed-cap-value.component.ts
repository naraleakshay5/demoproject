...
@Component({
  selector: 'app-fqa-printed-cap-value',
  templateUrl: './fqa-printed-cap-value.component.html',
  styleUrls: ['./fqa-printed-cap-value.component.scss'],
})
export class FqaPrintedCapValueComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
  ...
  proceed() {
    this.fqaService.testComplete('Cap Value Check');
