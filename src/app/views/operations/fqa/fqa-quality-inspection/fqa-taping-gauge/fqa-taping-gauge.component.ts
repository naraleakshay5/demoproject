...
@Component({
  selector: 'app-fqa-taping-gauge',
  templateUrl: './fqa-taping-gauge.component.html',
  styleUrls: ['./fqa-taping-gauge.component.scss'],
})
export class FqaTapingGaugeComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
  ...
  proceed() {
    this.fqaService.testComplete('Taping gauge');
