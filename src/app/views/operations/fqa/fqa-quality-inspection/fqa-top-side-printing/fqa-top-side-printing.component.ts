...
@Component({
  selector: 'app-fqa-top-side-printing',
  templateUrl: './fqa-top-side-printing.component.html',
  styleUrls: ['./fqa-top-side-printing.component.scss'],
})
export class FqaTopSidePrintingComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
