...
@Component({
  selector: 'app-fqa-capacitor-dimensions',
  templateUrl: './fqa-capacitor-dimensions.component.html',
  styleUrls: ['./fqa-capacitor-dimensions.component.scss'],
})
export class FqaCapacitorDimensionsComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
  ...
  getSpcvisualInspect() {
    const type = 'capacitor dimensions';
    this.sharedService
  ...
  proceed() {
    this.fqaService.testComplete('Dimensions Check');
