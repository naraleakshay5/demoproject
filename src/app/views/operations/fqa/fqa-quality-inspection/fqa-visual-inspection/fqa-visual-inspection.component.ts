...
@Component({
  selector: 'app-fqa-visual-inspection',
  templateUrl: './fqa-visual-inspection.component.html',
  styleUrls: ['./fqa-visual-inspection.component.scss'],
})
export class FqaQtyVisualInspectionComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
