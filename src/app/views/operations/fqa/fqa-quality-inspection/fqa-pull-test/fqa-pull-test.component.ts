...
@Component({
  selector: 'app-fqa-pull-test',
  templateUrl: './fqa-pull-test.component.html',
  styleUrls: ['./fqa-pull-test.component.scss'],
})
export class FqaPullTestComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
