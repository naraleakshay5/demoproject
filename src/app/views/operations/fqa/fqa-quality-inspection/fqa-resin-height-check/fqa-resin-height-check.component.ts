...
@Component({
  selector: 'app-fqa-resin-height-check',
  templateUrl: './fqa-resin-height-check.component.html',
  styleUrls: ['./fqa-resin-height-check.component.scss'],
})
export class FqaResinHeightCheckComponent implements OnInit {
  poData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
  ...
  proceed() {
    this.fqaService.testComplete('Resin Height Check');
