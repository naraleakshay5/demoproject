import { poData } from './../../tempering/tempering-model';
...
import { tray } from '../../assembly/assembly-model';
import { SharedService } from '../../Shared/shared.service';

@Component({
  selector: 'app-offline-input-carrier-scan',
  templateUrl: './offline-input-carrier-scan.component.html',
  styleUrls: ['./offline-input-carrier-scan.component.scss'],
})
export class OfflineInputCarrierScanComponent implements OnInit {
  ...
  getTrays() {
    this.sharedService
      .materialCarrierBinded(this.processId, this.poData?.po_id)
      .subscribe((res: any) => {
  ...
  proceed() {
    this.router.navigate(['op/offline/line-clearance']);
