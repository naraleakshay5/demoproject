...
@Component({
  selector: 'app-offline-recipe-setup',
  templateUrl: './offline-recipe-setup.component.html',
  styleUrls: ['./offline-recipe-setup.component.scss'],
})
export class OfflineRecipeSetupComponent implements OnInit {
  recipeAlready: any;
  machineData: any;
  machineId!: number;
