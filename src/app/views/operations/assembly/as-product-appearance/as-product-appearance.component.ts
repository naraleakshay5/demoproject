...
@Component({
  selector: 'app-as-product-appearance',
  templateUrl: './as-product-appearance.component.html',
  styleUrls: ['./as-product-appearance.component.scss'],
})
export class AsProductAppearanceComponent implements OnInit {
  ...
  proceed() {
    ...
    const reqobj = {
      poid: this.curingPoData.po_id,
      sachid: this.curingPoData.sach_id,
      machineId: this.machineId,
      processId: this.processId,
      results: req,
    };
    this.sharedService
      .postSpcVisualResults(this.curingPoData?.po_id, reqobj)
      .subscribe();
  }
  ...
  failSamples() {
    let heightSample = this.visualInspect.filter(
      (ele: any) => ele.parameter == 'product appearance'
    );
