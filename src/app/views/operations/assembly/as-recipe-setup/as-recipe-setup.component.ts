...
import { loadrecipe, poData } from '../assembly-model';
import { AssemblyService } from '../assembly.service';
@Component({
  selector: 'app-as-recipe-setup',
  templateUrl: './as-recipe-setup.component.html',
  styleUrls: ['./as-recipe-setup.component.scss'],
})
export class AsRecipeSetupComponent implements OnInit {
  turns: any = [];
  message: string = '';
  ...
  ngOnInit(): void {
    ...
    this.machineData = this.machineData.filter(
  ...
  getLoadRecipe() {
    this.sharedService
      .getLoadRecipe(this.machineData[0].id)
      .subscribe((res: any) => {
