...
@Component({
  selector: 'app-as-regin-height-check',
  templateUrl: './as-regin-height-check.component.html',
  styleUrls: ['./as-regin-height-check.component.scss'],
})
export class AsReginHeightCheckComponent implements OnInit {
