...
@Component({
  selector: 'app-as-lead-length-check',
  templateUrl: './as-lead-length-check.component.html',
  styleUrls: ['./as-lead-length-check.component.scss'],
})
export class AsLeadLengthCheckComponent implements OnInit {
  wicPoData!: PO_DATA;
  machineId: any;
  processId: any;
  visualInspect: any[] = [];
